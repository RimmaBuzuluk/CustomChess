...
public class BlackPlayer implements PlayerMoveHandler {
    ...
    public BlackPlayer(ChessBoardFragment context, RecyclerView recyclerView, OneDeviceGame oneDeviceGame) {
    ...
    public void clickHandler(Position position, int index, int imageResourceId) {
        ...
        if (startHolder != null && destinationHolder != null) {
            ...
            if (startHolder.getFigure().isBlack(imageResourceId)) {
                start = position;
                startIndex = index;
                imageResource = imageResourceId;
                return;
            ...
            try {
                ...
                context.setMoveHandler(new WhitePlayer(context, recyclerView, game));
